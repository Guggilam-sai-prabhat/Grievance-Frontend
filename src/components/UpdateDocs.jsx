...
const UpdateDocs=()=>{
    ...
    const getGrievance=async(e)=>{
      e.preventDefault();
      try{
       const res=await fetch('https://grievance-backend-ptts.onrender.com/grievancelist',{
        method: "GET",
        headers:{
    ...
    const updateData=async(e)=>{
        ...
        try{
         ...
         const res=await fetch(`https://grievance-backend-ptts.onrender.com/aAbBcC/updatedocs`,{
            method: "POST",
            headers:{
                "Content-Type":"application/json",
                'Accept': 'application/json'
